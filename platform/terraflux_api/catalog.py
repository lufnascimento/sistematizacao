...
PRODUCTS: dict[str, dict] = {
    ...
    "PCX5_WATER_SURFACE_PROFILE_SCREENING": {
        "label": "Perfil preliminar da lamina",
        "description": "Calcula como a profundidade pode variar ao longo de cada trecho subcritico declarado.",
        "stage": "E0_TRIAGEM",
        "implementation": "ENGINE_AVAILABLE_LIMITED",
        "client_engine": "project_hydrology_screening",
        "depends_on_product_ids": ["PCX1_RUNOFF_SCREENING", "PCX2_HYDROGRAPH_SCREENING", "PCX3_REACH_ROUTING_SCREENING", "PCX4_SECTION_CAPACITY_SCREENING"],
        "required_asset_groups": [],
        "limitations": ["STEADY_SUBCRITICAL_ONLY", "PRISMATIC_TRAPEZOID_ONLY", "NO_STRUCTURES", "NO_UNSTEADY_FLOW", "GUIDANCE_NOT_AUTHORIZED"],
    },
    "PCX6_OVERFLOW_PATH_SCREENING": {
        "label": "Caminhos de extravasamento",
        "description": "Verifica se os caminhos declarados descem ate o receptor e se cruzam barreiras conhecidas.",
        "stage": "E0_TRIAGEM",
        "implementation": "ENGINE_AVAILABLE_LIMITED",
        "client_engine": "project_hydrology_screening",
        "depends_on_product_ids": ["PCX1_RUNOFF_SCREENING", "PCX2_HYDROGRAPH_SCREENING", "PCX3_REACH_ROUTING_SCREENING", "PCX4_SECTION_CAPACITY_SCREENING", "PCX5_WATER_SURFACE_PROFILE_SCREENING"],
        "required_asset_groups": [],
        "limitations": ["DECLARED_GEOMETRY_ONLY", "NO_TERRAIN_DERIVED_PATH", "NO_RECEIVER_CAPACITY", "NO_HYDRAULIC_APPROVAL", "GUIDANCE_NOT_AUTHORIZED"],
    },
    "C2_BROAD_BASE": {
...
ENGINE_CATALOG: dict[str, dict] = {
    ...
    "project_hydrology_screening": {
        ...
        "mode": "CLIENT_DATA",
        "executes_external_process": False,
        "supported_product_ids": ["PCX1_RUNOFF_SCREENING", "PCX2_HYDROGRAPH_SCREENING", "PCX3_REACH_ROUTING_SCREENING", "PCX4_SECTION_CAPACITY_SCREENING", "PCX5_WATER_SURFACE_PROFILE_SCREENING", "PCX6_OVERFLOW_PATH_SCREENING"],
