...
O motor CF0 1.2 resolve a família contínua geométrica, mas permanece `HYDRAULIC_UNCONFIRMED`. O estágio `C1_ALIGNMENT_SCREENING` gera sensibilidade TI limitada; PCE0/PCX0 cobrem triagem RUSLE e balanço volumétrico; **Chuva que vira escoamento** gera os pulsos excedentes; e **Hidrograma preliminar** agora calcula vazão no tempo e pico com conservação de volume. Nenhum desses estágios propaga a onda na rede, dimensiona seção, valida receptor ou autoriza guiamento. O próximo incremento é o roteamento por alcances, seguido de seções e receptores para formar o PCX completo e, sobre ele, os solvers dimensionados de curva embutida, base larga/passante e ESD. Em paralelo, a campanha de aquisição deve fechar controle vertical, solo, chuva, bacia/receptores, interferências e frota.
